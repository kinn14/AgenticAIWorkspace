...
# installed.
TCL_PREFIX='E:/agenticAI/AgenticAIWorkspace/venvAgentic\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/agenticAI/AgenticAIWorkspace/venvAgentic\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/agenticAI/AgenticAIWorkspace/venvAgentic\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/agenticAI/AgenticAIWorkspace/venvAgentic\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/agenticAI/AgenticAIWorkspace/venvAgentic\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/agenticAI/AgenticAIWorkspace/venvAgentic\Library\lib\tclstub86.lib'
